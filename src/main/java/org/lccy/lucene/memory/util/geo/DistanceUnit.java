package org.lccy.lucene.memory.util.geo;

import org.lccy.lucene.memory.util.GeoUtil;

/**
 * 类名称： <br>
 * 类描述： <br>
 *
 * @Date: 2023/12/04 15:11 <br>
 * @author: liuchen11
 */
public enum DistanceUnit {
    ...
    public double getEarthCircumference() {
        return GeoUtil.EARTH_EQUATOR / meters;
    }
    ...
    public double getEarthRadius() {
        return GeoUtil.EARTH_SEMI_MAJOR_AXIS / meters;
    }
    ...
    public double getDistancePerDegree() {
        return GeoUtil.EARTH_EQUATOR / (360.0 * meters);
    }
